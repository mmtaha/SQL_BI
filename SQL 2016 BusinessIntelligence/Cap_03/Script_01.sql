...
Parâmetros: Ano INT e Mês INT
Descrição: Fazer uma consulta na tabela de Pedidos do banco Pedidos agrupando por Ano, mês e dia e inserir na tabela dim_Periodo.
...
Parâmetros: Ano INT e Mês INT
Descrição: Fazer uma consulta na tabela de Pedidos do banco Pedidos agrupando por Produto, Ano, mês e dia e inserir na tabela dim_Produto.
...
/*4.	Criar uma procedure para apagar um período de informações:
Nome: SP_Apaga_Carga
Parâmetros: Ano INT e Mês INT
